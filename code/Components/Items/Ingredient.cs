...
public class Ingredient : Item
{
	...
	[Property]
	[Description("The state of the ingredient that makes it servable")]
	public IngredientState ServableState { get; set; }
	...
	public bool Servable => State == ServableState;
	...
	public void SetState(IngredientState state)
	{
		...
		ModelRenderer.Model = state switch
		{
			...
			IngredientState.Burned => BurnedModel,
			_ => Model
		};
	}
}
